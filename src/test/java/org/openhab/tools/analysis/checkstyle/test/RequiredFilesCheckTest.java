...
public class RequiredFilesCheckTest extends AbstractStaticCheckTest {
    ...
    private static final String ABOUT_HTML_FILE_NAME = "about" + HTML_EXTENSION;
    private static final String BUILD_PROPERTIES_FILE_NAME = "build" + PROPERTIES_EXTENSION;
    private static final String POM_XML_FILE_NAME = "pom" + XML_EXTENSION;
    private static final String MANIFEST_MF_FILE_NAME = "MANIFEST" + MF_EXTENSION;
    private static final String README_MD_FILE_NAME = "README" + MD_EXTENSION;
    ...
    public static void setUpClass() {
        ...
        String extenstionsPropertyValue = String.format("%s,%s,%s,%s,%s", HTML_EXTENSION, PROPERTIES_EXTENSION,
                XML_EXTENSION, MF_EXTENSION, MD_EXTENSION);
    ...
    public void testMissingAboutHtmlFile() throws Exception {
        verifyDirectory("missing_about_html_directory", ABOUT_HTML_FILE_NAME,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, ABOUT_HTML_FILE_NAME));
    }
    ...
    public void testMissingBuildPropertiesFile() throws Exception {
        verifyDirectory("missing_build_properties_directory", BUILD_PROPERTIES_FILE_NAME,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, BUILD_PROPERTIES_FILE_NAME));
    }
    ...
    public void testMissingPomXmlFile() throws Exception {
        verifyDirectory("missing_pom_xml_directory", POM_XML_FILE_NAME,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, POM_XML_FILE_NAME));
    }
    ...
    public void testMissingManifestMfFile() throws Exception {
        verifyDirectory("missing_manifest_mf_directory", MANIFEST_MF_FILE_NAME,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, MANIFEST_MF_FILE_NAME));
    }
    ...
    public void testMissingReadmeMdFile() throws Exception {
        verifyDirectory("missing_readme_md_directory", README_MD_FILE_NAME,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, README_MD_FILE_NAME));
    }
    ...
    private void addExpectedViolation(Map<String, List<String>> expectedViolations, String fileName) {
        String[] expectedMessages = generateExpectedMessages(0,
                String.format(RequiredFilesCheck.MISSING_FILE_MSG, fileName));
